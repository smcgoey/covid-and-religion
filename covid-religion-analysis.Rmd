...
# Load packages: Tidyverse, Tidycensus, Janitor, scales, mapview, ggthemes
library(tidyverse)
library(janitor)
library(tidycensus)
library(scales)
...
First, we'll load in the county-level COVID data from The New York Times and the 2010 Religious Congregation Membership Study from the Association of Religion Data Archives.

```{r}

# Read in NYT county data
...
rmcs_religion_data <- read.csv("data/rcms_2010.csv") %>%
  clean_names()
